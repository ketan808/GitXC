...
const Boxes = ({ index, text }) => (
  <InView triggerOnce>
    {({ inView, ref }) => (
      ...
      >
      <Card className='theme100' shadow="sm" padding="lg" radius="md" withBorder lightHidden><div>{text}</div><div className="iconRight"><IconChevronRight color="#51cf66" size="1.5rem" stroke={2}/></div></Card>
      <Card className='theme100' shadow="sm" padding="lg" radius="md" withBorder darkHidden><div>{text}</div><div className="iconRight"><IconChevronRight color="#0f8122" size="1.5rem" stroke={2}/></div></Card>
